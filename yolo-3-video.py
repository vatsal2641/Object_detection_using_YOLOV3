...
video = cv2.VideoCapture(
    r'C:\Users\sumit\Downloads\YOLO-3-OpenCV\YOLO-3-OpenCV\videos\traffic-cars.mp4')
...
with open(r'C:\Users\sumit\Downloads\YOLO-3-OpenCV\YOLO-3-OpenCV\yolo-coco-data\coco.names') as f:
...
network = cv2.dnn.readNetFromDarknet(r'C:\Users\sumit\Downloads\YOLO-3-OpenCV\YOLO-3-OpenCV\yolo-coco-data\yolov3.cfg',
                                     r'C:\Users\sumit\Downloads\YOLO-3-OpenCV\YOLO-3-OpenCV\yolo-coco-data\yolov3.weights')
...
while True:
    ...
    if writer is None:
        ...
        writer = cv2.VideoWriter(r'C:\Users\sumit\Downloads\YOLO-3-OpenCV\YOLO-3-OpenCV\videos\traffic-cars.mp4', fourcc, 30,
